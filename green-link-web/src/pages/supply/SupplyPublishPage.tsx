...
interface LeaveBlockerModalProps {
  onProceed: () => void
  onStay: () => void
}

function LeaveBlockerModal({ onProceed, onStay }: LeaveBlockerModalProps) {
  return (
      ...
      <div className="relative rounded-2xl bg-white p-8 shadow-xl max-w-sm w-full mx-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={onProceed}
            className="flex-1 rounded-lg bg-red-500 py-2.5 text-sm font-medium text-white hover:bg-red-600 transition-all duration-200"
          >
            确认离开
          </button>
        </div>
